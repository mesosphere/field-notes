This is a parameterized way to install Kafka in strict mode, using a [custom zookeeper](api-kafka-zookeeper.md),  without the `dcos security` command line tool

*If not using a custom zookeeper, use [api-kafka](api-kafka.md)*
